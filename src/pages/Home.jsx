    ...
    <div className="mt-20" id="home">
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          >
          I'm currently learning IT at HCMUTE, my specialization is AI but I'm learning web dev to have more experience and with the view to demonstrate my AI project into a GUI application.          </motion.p>
